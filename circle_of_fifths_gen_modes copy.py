...
colors[2][len(colors[2])-1] = "#88E788"
colors[2][len(colors[2])-2] = "#88E788"
colors[2][0] = "#88E788"

colors[3][len(colors[2])-1] = "#6598DF"
colors[3][len(colors[2])-2] = "#6598DF"
colors[3][0] = "#6598DF"

colors[4][len(colors[2])-1] = "#FC6A21"




#colors[2] = shift_list(colors[2], 3, "right")  
...
for i in range(len(major)):
    ...
    #text_colors_shifted[2] = shift_list(text_colors_shifted[2], i)
    #text_colors_shifted[3] = shift_list(text_colors_shifted[3], i)
