inverions = {
    'major':{ 
              '123':
              {'root':[('5','-2'),('3','0'),('root','0')],
              '1st_inversion':[('root','0'),('5','0'),('3','+1')],
              '2nd_inversion':[('3','-1'),('root','0'),('5','-1')]},
              '234':
              {'root':[('5','-2'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','-1'),('3','+1')],
              '2nd_inversion':[('3','0'),('root','0'),('5','0')]},
              '345':
              {'root':[('5','-3'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','0'),('3','+2')],
              '2nd_inversion':[('3','-1'),('root','0'),('5','0')]},
              '456':
              {'root':[('5','-3'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','0'),('3','+2')],
              '2nd_inversion':[('3','-1'),('root','0'),('5','0')]},
    ...
    'minor':{ 
              '123':
              {'root':[('5','-2'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','0'),('3','0')],
              '2nd_inversion':[('3','-2'),('root','0'),('5','-1')]},
              '234':
              {'root':[('5','-2'),('3','-2'),('root','0')],
              '1st_inversion':[('root','0'),('5','-1'),('3','0')],
              '2nd_inversion':[('3','-1'),('root','0'),('5','0')]},
              '345':
              {'root':[('5','-3'),('3','-2'),('root','0')],
              '1st_inversion':[('root','0'),('5','0'),('3','+1')],
              '2nd_inversion':[('3','-2'),('root','0'),('5','0')]},
              '456':
              {'root':[('5','-3'),('3','-2'),('root','0')],
              '1st_inversion':[('root','0'),('5','0'),('3','+1')],
              '2nd_inversion':[('3','-2'),('root','0'),('5','0')]}
    ...
    'augmented':{ 
              ...
              {'root':[('5','-1'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','0'),('3','+1')],
              '2nd_inversion':[('3','0'),('root','0'),('5','+1')]},
              '345':
              {'root':[('5','-2'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','+1'),('3','+2')],
              '2nd_inversion':[('3','-1'),('root','0'),('5','+1')]},
              '456':
              {'root':[('5','-2'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','+1'),('3','+2')],
    ...
    'diminished':{ 
              ...
              {'root':[('5','-3'),('3','-1'),('root','0')],
              '1st_inversion':[('root','0'),('5','-1'),('3','0')],
              '2nd_inversion':[('3','-2'),('root','0'),('5','-2')]},
              '234':
              {'root':[('5','-3'),('3','-2'),('root','0')],
              '1st_inversion':[('root','0'),('5','-2'),('3','0')],
              '2nd_inversion':[('3','-1'),('root','0'),('5','-1')]},
              '345':
              {'root':[('5','-4'),('3','-2'),('root','0')],
              '1st_inversion':[('root','0'),('5','-1'),('3','+1')],
...
chromatic_notes = ["C", "C_sharp", "D", "D_sharp", "E", "F", "F_sharp", "G", "G_sharp", "A", "A_sharp", "B"]
...
def runOnTriadType(triad,sroot,triad_name):
    #print(triad)
    #print(inverions[triad])
    return runOnSringSets(inverions[triad],sroot,triad_name)



def runOnSringSets(triadType,sroot,triad_name):
    #print(triadType)
    noteDic = {}
    the_actual5 = '5'
    the_actual3 = '3'
                    ...
                    for index, note in enumerate(notes_list):
                        if note[0] == "root":
                            if index+1 == key:
                                ...
                                valid = 1
                                fretboard_position_5th = int(offset)+int(notes_list[(index+1)%3][1])
                                if fretboard_position_5th > -1 and fretboard_position_5th < 23:
                                    note_5th = strings_notes_22frets[loc_5th][fretboard_position_5th]
                                    print(f"{loc_5th} Note: 5, Position: {offset} - {note_5th}")
                                    valid = valid + 1

                                loc_3rd = "string"+str(strg+(index+2)%3)
                                fretboard_position_3rd = int(offset)+int(notes_list[(index+2)%3][1])
                                if fretboard_position_3rd > -1 and fretboard_position_3rd < 23:
                                    note_3rd = strings_notes_22frets[loc_3rd][fretboard_position_3rd]
                                    print(f"{loc_3rd} Note: 3 , Position: {offset} - {note_3rd}")
                                    valid = valid + 1

                                final_inversion_notes = {}
                                if valid == 3:
                                    final_inversion_notes[rootPos+strg] = ("R",offset, note_root)
                                    final_inversion_notes[pos5th+strg] = (the_actual5,fretboard_position_5th, note_5th)
                                    final_inversion_notes[pose3rd+strg] = (the_actual3,fretboard_position_3rd, note_3rd)
...
notes = {}
for i,j in enumerate(triadTypes):
    notes[triadTypes[i]] = {}
    for key,note in enumerate(chromatic_notes):
        dit = runOnTriadType(triadTypes[i],note,triadTypes[i])
        notes[triadTypes[i]][note] = dit
print("ff"*200)
#print(notes)
...
with open("two_level_dict_new.json", "w") as file:
