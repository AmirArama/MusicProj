interval_to_semitones = {
    ...
    "#13": {"name": "sharp_thirteenth", "semitones": 22},
...
chord_types = {
    ...
    'Dominant thirteenth': {'Symbols': ['13', 'dom13'], 'Function': ['1', '3', 'b7', '13'], 'PossibleVoicings': ['closed_4note', 'drop_2', 'drop_3', 'drop_2_and_4', 'drop_2_and_3']}, 
    ...
    'Dominant sharp thirteen': {'Symbols': ['7♯13'], 'Function': ['1', '3', 'b7', '#13'], 'PossibleVoicings': ['drop_2_and_4', 'drop_2_and_3']}, 
