                    ...
                    for index, note in enumerate(notes_list):
                        if note[0] == "root":
                            if index+1 == key:
                                ...
                                if valid == 3:
                                    final_inversion_notes[rootPos+strg] = ("root",offset, note_root)
                                    final_inversion_notes[pos5th+strg] = ("5th",fretboard_position_5th, note_5th)
                                    final_inversion_notes[pose3rd+strg] = ("3rd",fretboard_position_3rd, note_3rd)
...
for i,j in enumerate(triadTypes):
    ...
    for key,note in enumerate(chromatic_notes):
        dit = runOnTriadType(triadTypes[i],note)
